...
public class TextExtractor {
    ...
    public static void main(String[] args) {
        String html = extractTextFromUrl("http://www.infoq.com/cn/articles/Kubernetes-system-architecture-introduction",new HashMap<String,String>(),false);
        System.out.println(html);
    }

//    public static String extractTextFromUrl(String url) {
//        String html = (String) HttpRequestUtil.submitRequest(url);
//        html = deleteLabel(html);
//        Map<Integer, String> map = splitBlock(html);
//        return judgeBlocks(map);
//    }

    public static String extractTextFromUrl(String url,Map<String,String> headers,boolean useProxy) {
        String html = (String) HttpRequestUtil.submitRequestWithHeaders(url,useProxy,headers);
        html = Jsoup.clean(html, new Whitelist());
        return html;
    }
